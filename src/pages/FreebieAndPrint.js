...
import { InputWithLabel, ImportButton, BackButton, CompleteButton, OptionRegistration, MultiSelect, ImportModal } from 'components/FreebieAndPrint';
    ...
    return (
        <Container>
            <Wrapper>
                ...
                {modalVisible && (
                    <ImportModal importJSON={importJSON} importData={importData} close={closeModal}/>
                )}
                <Description>이미 등록된 사은품 또는 인쇄물 정보를 수정하고 싶다면 우측 상단의 '불러오기'를 클릭하세요.</Description>
                <br />
                <InputWithLabel label='이름' onChange={(e) => { onChange(e) }} value={title} placeholder="사은품 또는 인쇄물의 이름을 입력해주세요" />
                <div>
                    <InputWrap>
                        <Label>분류</Label>
                        <Select
                ...
                <RadioBox>
                    <input
                        ...
                        onChange={() => { handleClickRadioButton('none') }} />
                    <label htmlFor='none' name='none'>옵션 없음</label>
                </RadioBox>
                <RadioBox>
                    <input
                        type='radio'
                        ...
                        onChange={() => { handleClickRadioButton('has') }} />
                    <label htmlFor='has' name='has'>옵션 있음</label>
                </RadioBox>
                <br />
