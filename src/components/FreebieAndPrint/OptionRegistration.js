    ...
    return (
        <>
            ...
            {props.optionStatus === 'has' && (
                <Wrapper>
                    <OptionHeader>
                        <OptionOneWrapper><input type='checkbox' name='option' value='all' onChange={() => {allChecked()}}></input></OptionOneWrapper>
                    ...
                    <OptionButton onClick={() => { onCreate(); }}>옵션 추가</OptionButton>
                    <OptionButton onClick={() => { onRemoveOption(); }}>선택 삭제</OptionButton>
                </Wrapper>
            )}
        </>
    )
